\begin{abstract}
    ...
    to centroid proxies. The study uses a global,
    population/built-volume-weighted random sample to compare four
    centroid baselines against the nearest tagged entrance for each
    sampled POI. We release
